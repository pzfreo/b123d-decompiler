...
def _hausdorff_helper_lines() -> list[str]:
    ...
    The functions are copied verbatim from ``b123d_decompiler.fingerprint.hausdorff`` and
    ``b123d_decompiler.fingerprint.analyze`` so the generated tests and the ``compare``
    ...
    lines = [
        ...
        "# (copied verbatim from b123d_decompiler.fingerprint.hausdorff / .analyze)",
        "# ═══════════════════════════════════════════════════════════",
        "",
    ]
    for obj in sources:
